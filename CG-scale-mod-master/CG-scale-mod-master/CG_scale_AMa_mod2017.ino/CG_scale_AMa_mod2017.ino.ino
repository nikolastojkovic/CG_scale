...
float WingPegDist = 120.1; //calibration value in mm, projected distance between wing support points, measure with calliper
...
void setup() 
  ...
  front_scale.begin(A2, A3);
  rear_scale.begin(A0, A1);
